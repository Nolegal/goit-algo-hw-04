...
header = "{:<20} | {:<20} | {:<20} | {:<20} | {:20}".format("Sorting Algoritm", "Data 10", "Data 100", "Data 1000", "Data 10000")
print(header)
print("-"*len(header))

for sort_func in sorting_functions:
    row="{:<20}".format(sort_func.__name__)
    for data in test_data:
        _,execution_time=measure_time(sort_func,data)
